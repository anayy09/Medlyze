            ...
            >
              <div className="mb-10 text-center">
                <Link href="/" className="mx-auto inline-block max-w-[160px]">
                  <Image
                    src="/images/logo/medlyze-logo-light.png"
                    alt="logo"
                    width={140}
                    height={30}
                  ...
                  />
                  <Image
                    src="/images/logo/medlyze-logo-dark.png"
                    alt="logo"
                    width={140}
                    height={30}
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-[22px]">
                    ...
                    >
                      ...
                      <option value="PATIENT" className="text-dark dark:text-white">
                        Patient - Access AI-powered health insights
                      </option>
                      <option value="DOCTOR" className="text-dark dark:text-white">
                        Doctor - Provide professional diagnosis
                      </option>
                    </select>
                  </div>
                  <div className="mb-9">
