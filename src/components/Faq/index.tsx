    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Find answers to common questions about Medlyze, our AI analysis, and how we protect your medical information."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="Our AI models are trained on millions of medical reports to identify patterns and anomalies. When you upload a report, our system analyzes it and provides both a patient-friendly summary and a technical summary for healthcare professionals. The analysis includes confidence scores and risk assessments."
            />
            <SingleFaq
              question="Is my medical data secure and private?"
              answer="Absolutely. We use AES-256 encryption for all files at rest and in transit. Your data is stored securely and never shared without your explicit permission. We are HIPAA-compliant and follow all medical data protection regulations. Only doctors you grant access to can view your reports."
            />
            <SingleFaq
              question="What types of medical reports can I upload?"
              answer="You can upload various types of medical reports including X-rays, CT scans, MRIs, ECGs/EKGs, blood test results, and pathology reports. We support PDF, PNG, and JPEG formats up to 10MB per file."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Can doctors add their own notes and diagnosis?"
              answer="Yes! Doctors can review the AI analysis and add their professional notes, diagnosis, and follow-up recommendations. This creates a comprehensive record that combines AI insights with expert medical opinion."
            />
            <SingleFaq
              question="How do I share my reports with my doctor?"
              answer="Simply enter your doctor's email address in the 'My Doctors' section of your dashboard and grant them access. Once approved, they can view all your reports and AI analyses. You can revoke access at any time."
            />
            <SingleFaq
              question="Do I need a subscription to use Medlyze?"
              answer="We offer a free plan that allows you to upload up to 5 reports per month and connect with 1 doctor. For unlimited reports and features like comprehensive analysis history and multiple doctor connections, consider our Premium plan at $9/month."
            />
          </div>
        </div>
      </div>
